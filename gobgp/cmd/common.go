...
func ApiStruct2Path(p *gobgpapi.Path) ([]*Path, error) {
	...
	//fmt.Println("AFI SAFI",afi,safi)
	//fmt.Println("BGPPrefixRouteFamily",bgp.NewPrefixFromRouteFamily(afi, safi))
	//fmt.Println("PREFIX NLRI",p.Nlri)
	//fmt.Println("++++++++++++++++++")
	//fmt.Println("PREFIX NLRI",nlri)
